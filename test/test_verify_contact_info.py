...
def test_verify_info_on_home_page(app):
    ...
    assert clear(contact_from_edit_page.primary_home_phone) == clear(contact_from_home_page.primary_home_phone)
    assert clear(contact_from_edit_page.work_phone) == clear(contact_from_home_page.work_phone)
    assert clear(contact_from_edit_page.mobile_phone) == clear(contact_from_home_page.mobile_phone)
    assert clear(contact_from_edit_page.secondary_home_phone) == clear(contact_from_home_page.secondary_home_phone)
